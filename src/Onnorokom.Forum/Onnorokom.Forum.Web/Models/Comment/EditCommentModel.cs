...
namespace Onnorokom.Forum.Web.Models.Comment
{
    public class EditCommentModel
    {
        ...
        public EditCommentModel(IPostService postService, ITopicService topicService,
        ...
        public async Task Edit(Guid userId)
        {
            ...
            if (user.Id != comment.CreatorId)
                throw new InvalidOperationException("You are not permitted to edit this comment.");

            await _commentService.Update(new BO.Comment
            {
                Id = Id,
