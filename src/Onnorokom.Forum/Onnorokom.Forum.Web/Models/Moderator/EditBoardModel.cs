...
namespace Onnorokom.Forum.Web.Models.Moderator
{
    public class EditBoardModel
    {
        ...
        public EditBoardModel(IBoardService boardService, IProfileService profileService)
        {
        ...
        public async Task EditBoard(string userEmail)
        {
            ...
            await _boardService.UpdateBoardName(new Board { BoardName = BoardName, Id = Id }, user.Id);
        }
    }
}